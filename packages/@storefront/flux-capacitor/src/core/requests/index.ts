...
export const productDetailsRequest = new RequestBuilder<Request>(RequestHelpers.productDetails, Configuration.detailsOverrides);
...
export const refinementsRequest = new RequestBuilder<Request>(RequestHelpers.products, Configuration.refinementsOverrides);
/* tslint:enable */
