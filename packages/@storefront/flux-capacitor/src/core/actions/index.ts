...
namespace Actions {
  ...
  export type ReceiveQuery = Action<typeof RECEIVE_QUERY, Payload.Query | Results>;
  export const RECEIVE_PRODUCT_RECORDS = 'RECEIVE_PRODUCT_RECORDS';
  export type ReceiveProductRecords = Action<typeof RECEIVE_PRODUCT_RECORDS, Store.ProductWithMetadata[] | Results>;
  ...
  export type ReceiveNavigations = Action<typeof RECEIVE_NAVIGATIONS, Store.Navigation[] | Results>;
  ...
  export type ReceiveRecordCount = Action<typeof RECEIVE_RECORD_COUNT, number | Results>;
  export const RECEIVE_TEMPLATE = 'RECEIVE_TEMPLATE';
  export type ReceiveTemplate = Action<typeof RECEIVE_TEMPLATE, Store.Template | Results>;
