...
suite('requests helpers', ({ expect, stub, spy }) => {
  ...
  describe('productDetails()', () => {
    it('should create a product details request using history', () => {
      const state: any = { area: 'oof', collection: 'rab', };
    ...
    it('should create a product details request using store fallbacks if history is not available', () => {
      const state: any = { area: 'oof', collection: 'rab', };
  ...
  describe('attachSessionId()', () => {
    it('should return a function that is called with the given request and add sessionId to the request', () => {
      const req = { a: 'b' };
      const sessionId = 'foo';
      const state: any = { c: 'd', session: { sessionId } };

      const requestWithSessionId = RequestHelpers.attachSessionId(state)(req);
